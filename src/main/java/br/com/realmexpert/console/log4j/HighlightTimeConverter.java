...
public class HighlightTimeConverter extends LogEventPatternConverter {
    ...
    public static String getError() {
        String cc = RealmExpertMCConfig.getHighlight("consolecolor.error-time", "c");
        return ANSIColorUtils.getColor(cc, "\u001B[31;1m");
    }

    public static String getWarn() {
        String cc = RealmExpertMCConfig.getHighlight("consolecolor.warn-time", "e");
        return ANSIColorUtils.getColor(cc, "\u001B[33;1m");
    }

    public static String getInfo() {
        String cc = RealmExpertMCConfig.getHighlight("consolecolor.info-time", "b");
        return ANSIColorUtils.getColor(cc, "\u001B[36;1m");
    }

    public static String getFatal() {
        String cc = RealmExpertMCConfig.getHighlight("consolecolor.fatal-time", "c");
        return ANSIColorUtils.getColor(cc, "\u001B[31;1m");
    }

    public static String getTrace() {
        String cc = RealmExpertMCConfig.getHighlight("consolecolor.trace-time", "c");
        return ANSIColorUtils.getColor(cc, "\u001B[31;1m");
    }
