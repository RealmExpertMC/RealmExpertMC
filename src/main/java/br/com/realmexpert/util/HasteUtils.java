package br.com.realmexpert.util;
...
public class HasteUtils {
    public static String pasteRealmExpertMC(String text) throws IOException {
        HttpURLConnection connection = (HttpURLConnection) new URL("https://haste.RealmExpertMC.com/documents").openConnection();
        ...
        rd.close();
        return "https://haste.RealmExpertMC.com/" + response.substring(response.indexOf(":") + 2, response.length() - 2);
    }
