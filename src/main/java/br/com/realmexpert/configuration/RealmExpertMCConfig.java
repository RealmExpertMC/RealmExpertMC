...
public class RealmExpertMCConfig extends ConfigBase {

    public static RealmExpertMCConfig instance;
    ...
    public final StringSetting server_type = new StringSetting(this, "RealmExpertMC.server-type", "FML");
    public final StringSetting lang = new StringSetting(this, "RealmExpertMC.lang", "xx_XX");
    public final StringSetting console_name = new StringSetting(this, "RealmExpertMC.console_name", "Server");
    public final BoolSetting support_nocmd = new BoolSetting(this, "RealmExpertMC.support_nocmd", false);
    ...
    public final BoolSetting use_custom_java8 = new BoolSetting(this, "RealmExpertMC.use_custom_java8", false);
	public final BoolSetting forge_can_call_bukkit = new BoolSetting(this, "RealmExpertMC.forge_can_call_bukkit", false);
    public final BoolSetting check_update = new BoolSetting(this, "RealmExpertMC.check_update", true);
    public final BoolSetting needToUpdate = new BoolSetting(this, "RealmExpertMC.check_update_auto_download", false);
    public final BoolSetting check_libraries = new BoolSetting(this, "RealmExpertMC.check_libraries", true);
    public final BoolSetting downloadfile_command_enabled = new BoolSetting(this, "RealmExpertMC.downloadfile_command_enabled", false);
    public final BoolSetting disable_plugins_blacklist = new BoolSetting(this, "RealmExpertMC.disable_plugins_blacklist", false);
    public final BoolSetting disable_mods_blacklist = new BoolSetting(this, "RealmExpertMC.disable_mods_blacklist", false);
    public final BoolSetting disable_config_update = new BoolSetting(this, "RealmExpertMC.disable_config_update", false);
    ...
    public final BoolSetting watchdog_spigot = new BoolSetting(this, "RealmExpertMC.watchdog_spigot", true);
    public final BoolSetting watchdog_RealmExpertMC = new BoolSetting(this, "RealmExpertMC.watchdog_RealmExpertMC", false);
    public final BoolSetting showlogo = new BoolSetting(this, "RealmExpertMC.showlogo", true);
    public final BoolSetting World_Directory_Client = new BoolSetting(this, "world.directory_in_client", true);
    public final BoolSetting bukkitPermissionsHandler = new BoolSetting(this, "RealmExpertMC.BukkitPermissionsHandler", true);

    public final BoolSetting disableforgegenerate_global = new BoolSetting(this, "world.disableforgegenerate.global.enable", false);
    public final StringSetting libraries_downloadsource = new StringSetting(this, "RealmExpertMC.libraries_downloadsource", Message.isCN() ? DownloadSource.CHINA.name() : DownloadSource.RealmExpertMC.name());
    // RealmExpertMCProxySelector
    public final BoolSetting debug_msg = new BoolSetting(this, "RealmExpertMC.networkmanager.debug", false);

    private final String HEADER = "This is the main configuration file for RealmExpertMC.\n"
            + "\n"
            + "Home: https://RealmExpertMC.com/\n";
    public List<String> autounloadworld_whitelist = new ArrayList();
    /* ======================================================================== */
    public List<Integer> dimensionsNotLoaded = new ArrayList();

    public final IntSetting connectionTimeout = new IntSetting(this, "RealmExpertMC.connectionTimeout", 15000);

    public RealmExpertMCConfig() {
        super("RealmExpertMC.yml");
        init();
        instance = this;
    }

    public static String getHighlight(String key, String def) {
        YamlConfiguration yml = YamlConfiguration.loadConfiguration(RealmExpertMCConfigUtil.RealmExpertMCyml);
        String color = yml.getString(key, def);
        return color;
    }

    public static void setValueRealmExpertMC(String oldValue, String value) {
        YamlConfiguration yml = YamlConfiguration.loadConfiguration(RealmExpertMCConfigUtil.RealmExpertMCyml);
        yml.set(oldValue, value);
        try {
            yml.save(RealmExpertMCConfigUtil.RealmExpertMCyml);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    public static void setValueRealmExpertMC(String oldValue, boolean value) {
        YamlConfiguration yml = YamlConfiguration.loadConfiguration(RealmExpertMCConfigUtil.RealmExpertMCyml);
        yml.set(oldValue, value);
        try {
            yml.save(RealmExpertMCConfigUtil.RealmExpertMCyml);
    ...
    private static void bungeeOnlineMode() {
        bungeeOnlineMode = instance.getBoolean("RealmExpertMC.bungee-online-mode", true);
    }
        ...
        for (Field f : this.getClass().getFields()) {
            if (Modifier.isFinal(f.getModifiers()) && Modifier.isPublic(f.getModifiers()) && !Modifier.isStatic(f.getModifiers())) {
                try {
                    ...
                    System.out.println("[RealmExpertMC] Failed to initialize a RealmExpertMCConfig setting.");
                    t.printStackTrace();
                }
            }
        }
