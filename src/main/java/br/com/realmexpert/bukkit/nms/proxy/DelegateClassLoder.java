...
public class DelegateClassLoder extends ClassLoader {
    ...
    public final Class<?> defineClassRealmExpertMC(byte[] b, int off, int len) throws ClassFormatError {
        return defineClassRealmExpertMC(null, b, off, len, null);
    }

    public final Class<?> defineClassRealmExpertMC(String name, byte[] b, int off, int len) throws ClassFormatError {
        return defineClassRealmExpertMC(name, b, off, len, null);
    }

    public final Class<?> defineClassRealmExpertMC(String name, java.nio.ByteBuffer b, ProtectionDomain protectionDomain) throws ClassFormatError {
    ...
    public final Class<?> defineClassRealmExpertMC(String name, byte[] b, int off, int len, ProtectionDomain protectionDomain) throws ClassFormatError {
        if (off == 0) {
