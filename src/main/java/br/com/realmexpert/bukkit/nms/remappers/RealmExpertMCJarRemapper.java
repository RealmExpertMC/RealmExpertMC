 ...
 */
public class RealmExpertMCJarRemapper extends CustomRemapper {

    public final RealmExpertMCJarMapping jarMapping;
    ...
    public RealmExpertMCJarRemapper(RemapperProcessor preProcessor, RealmExpertMCJarMapping jarMapping, RemapperProcessor postProcessor) {
        this.preProcessor = preProcessor;
        this.jarMapping = jarMapping;
        this.postProcessor = postProcessor;
    }

    public RealmExpertMCJarRemapper(RemapperProcessor remapperPreprocessor, RealmExpertMCJarMapping jarMapping) {
        this(remapperPreprocessor, jarMapping, null);
    }

    public RealmExpertMCJarRemapper(RealmExpertMCJarMapping jarMapping) {
        this.jarMapping = jarMapping;
    }
