...
import br.com.realmexpert.bukkit.nms.proxy.DelegateClassLoder;
import br.com.realmexpert.bukkit.nms.proxy.DelegateURLClassLoder;
import br.com.realmexpert.bukkit.nms.utils.ASMUtils;
import br.com.realmexpert.bukkit.pluginfix.JavaScriptRemaper;
...
public class RealmExpertMCSuperClassRemapper {
    ...
    public static void init(ClassNode node) {
        ...
        Class<?> superClass = RealmExpertMCSuperClassRemapper.superClassMap.get(node.superName);
        if (superClass != null) {
