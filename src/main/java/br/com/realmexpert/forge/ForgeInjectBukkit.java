...
import br.com.realmexpert.api.BlockAPI;
import br.com.realmexpert.api.ItemAPI;
        ...
        for (Map.Entry<ResourceLocation, Item> entry : ForgeRegistries.ITEMS.getEntries()) {
            ...
            if (!key.getResourceDomain().equals("minecraft")) {
                ...
                if (material != null) {
                    ...
                    RealmExpertMC.LOGGER.debug("Save: " + Message.getFormatString("injected.item", new Object[]{material.name(), String.valueOf(material.getId()), String.valueOf(ItemAPI.getBukkit(material).getDurability())}));
                }
            }
        }
    }
        ...
        for (Map.Entry<ResourceLocation, Block> entry : ForgeRegistries.BLOCKS.getEntries()) {
            ...
            if (!key.getResourceDomain().equals("minecraft")) {
                ...
                if (material != null) {
                    ...
                    // <bukkit_id, modid>
                    ItemAPI.MODID_MAP.put(id, modid);
                    RealmExpertMC.LOGGER.debug("Save: " + Message.getFormatString("injected.block", new Object[]{material.name(), String.valueOf(material.getBlockID())}));
                }
            }
        }
    ...
    public static void addEnumVillagerProfession() {
        ...
        for (Map.Entry<Integer, VillagerRegistry.VillagerProfession> entry : map.entrySet()) {
            if (entry.getKey() > 5) {
                ...
                RealmExpertMC.LOGGER.debug("Save: " + Message.getFormatString("injected.villager", new Object[]{vp.name(), vc.name(), String.valueOf(vp.ordinal() - 2)}));
            }
        }
