...
public class JavaPluginLoader implements PluginLoader {
    ...
    public Plugin loadPlugin(File file) throws InvalidPluginException {
        ...
        if (dataFolder.equals(oldDataFolder)) {
            ...
            RealmExpertMC.LOGGER.info(String.format(
    ...
    public Map<Class<? extends Event>, Set<RegisteredListener>> createRegisteredListeners(Listener listener, Plugin plugin) {
        ...
        try {
            ...
            RealmExpertMC.LOGGER.error("Plugin " + plugin.getDescription().getFullName() + " has failed to register events for " + listener.getClass() + " because " + e.getMessage() + " does not exist.");
            return ret;
        }
        ...
        for (Method method : methods) {
            ...
            if (method.getParameterTypes().length != 1 || !Event.class.isAssignableFrom(checkClass = method.getParameterTypes()[0])) {
                RealmExpertMC.LOGGER.error(plugin.getDescription().getFullName() + " attempted to register an invalid EventHandler method signature \"" + method.toGenericString() + "\" in " + listener.getClass());
                continue;
            }
            ...
            for (Class<?> clazz = eventClass; Event.class.isAssignableFrom(clazz); clazz = clazz.getSuperclass()) {
                ...
                if (clazz.getAnnotation(Deprecated.class) != null) {
                    ...
                    RealmExpertMC.LOGGER.warn(String.format(
    ...
    public void enablePlugin(Plugin plugin) {
        ...
        if (!plugin.isEnabled()) {
            RealmExpertMC.LOGGER.info(Message.getFormatString("bukkit.plugin.enabling", pn));
            ...
            if (!loaders.contains(pluginLoader)) {
                ...
                RealmExpertMC.LOGGER.error(Message.getFormatString("bukkit.plugin.enablingunreg", pn));
            }
            try {
                jPlugin.setEnabled(true);
            } catch (Throwable ex) {
                RealmExpertMC.LOGGER.error(Message.getFormatString("bukkit.plugin.enablingerror", pn), ex);
            }
    ...
    public void disablePlugin(Plugin plugin) {
        ...
        if (plugin.isEnabled()) {
            RealmExpertMC.LOGGER.info(Message.getFormatString("bukkit.plugin.disabling", new Object[]{plugin.getDescription().getFullName()}));
            ...
            try {
                ...
                RealmExpertMC.LOGGER.error(Message.getFormatString("bukkit.plugin.disablingerror", new Object[]{plugin.getDescription().getFullName()}), ex);
            }
            ...
            if (cloader instanceof PluginClassLoader) {
                ...
                try {
                    ...
                    RealmExpertMC.LOGGER.info("Error closing the Plugin Class Loader for " + plugin.getDescription().getFullName());
                    e.printStackTrace();
                }
                // Paper end
            }
