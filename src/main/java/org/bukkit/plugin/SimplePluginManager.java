    ...
    public Plugin[] loadPlugins(File directory) {
        ...
        for (File file : directory.listFiles()) {
            ...
            try {
                ...
                if (name.equalsIgnoreCase("bukkit") || name.equalsIgnoreCase("minecraft") || name.equalsIgnoreCase("mojang") || name.equalsIgnoreCase("spigot") || name.equalsIgnoreCase("forge") || name.equalsIgnoreCase("paper") || name.equalsIgnoreCase("RealmExpertMC")) {
                    RealmExpertMC.LOGGER.error("Could not load '" + file.getPath() + "' in folder '" + directory.getPath() + "': Restricted Name");
                    continue;
                } else if (description.rawName.indexOf(' ') != -1) {
                    RealmExpertMC.LOGGER.error("Could not load '" + file.getPath() + "' in folder '" + directory.getPath() + "': uses the space-character (0x20) in its name");
                    continue;
                }
            } catch (InvalidDescriptionException ex) {
                RealmExpertMC.LOGGER.error(Message.getFormatString("exception.invalid.description", new Object[]{file.getPath(), directory.getPath()}), ex);//by: lliiooll
                continue;
            }
        ...
        loadedPlugins.addAll(ImmutableSet.of("RealmExpertMC", "Forge"));
            ...
            while (pluginIterator.hasNext()) {
                ...
                if (!(dependencies.containsKey(plugin) || softDependencies.containsKey(plugin)) && plugins.containsKey(plugin)) {
                    ...
                    try {
                        ...
                        RealmExpertMC.LOGGER.error(Message.getFormatString("exception.invalid.plugin", new Object[]{file.getPath(), directory.getPath()}), ex);//by: lliiooll
                    }
                }
            }
            ...
            if (missingDependency) {
                ...
                if (missingDependency) {
                    ...
                    while (failedPluginIterator.hasNext()) {
                        ...
                        RealmExpertMC.LOGGER.error("Could not load '" + file.getPath() + "' in folder '" + directory.getPath() + "': circular dependency detected");
                    }
                }
            }
        }
        ...
        for (RegisteredListener registration : listeners) {
            ...
            try {
                ...
                if (plugin.isNaggable()) {
                    ...
                    RealmExpertMC.LOGGER.error(String.format(
