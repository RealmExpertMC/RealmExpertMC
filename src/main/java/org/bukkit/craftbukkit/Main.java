        ...
        OptionParser parser = new OptionParser() {
            {
                ...
                // RealmExpertMC Start
                acceptsAll(asList("RealmExpertMC", "RealmExpertMC-settings"), "File for RealmExpertMC settings")
                        .withRequiredArg()
                        .ofType(File.class)
                        .defaultsTo(new File("RealmExpertMC-config", "RealmExpertMC.yml"))
                        .describedAs("Yml file");
                // RealmExpertMC End
                ...
                acceptsAll(asList("server-name"), "Name of the server")
                        .withRequiredArg()
                        .ofType(String.class)
                        .defaultsTo("RealmExpertMC Server")
                        .describedAs("Name");
                // Paper end
            }
        };
