    ...
    public HelpYamlReader(Server server) {
        ...
        try {
            ...
            try {
                ...
                RealmExpertMC.LOGGER.error("Could not save " + helpYamlFile, ex);
            }
        } catch (Exception ex) {
            RealmExpertMC.LOGGER.error("Failed to load help.yml. Verify the yaml indentation is correct. Reverting to default help.yml.");
