...
import br.com.realmexpert.entity.CraftCustomAbstractHorse;
import br.com.realmexpert.entity.CraftCustomChestHorse;
import br.com.realmexpert.entity.CraftCustomEntity;
import br.com.realmexpert.entity.CustomProjectileEntity;
...
public abstract class CraftEntity implements org.bukkit.entity.Entity {
    ...
    public static CraftEntity getEntity(CraftServer server, Entity entity) {
        ...
        if (entity instanceof EntityLivingBase) {
                    ...
                    if (entity instanceof EntityChicken) {
                        ...
                        if (entity instanceof AbstractChestHorse) {
                            if (entity instanceof EntityDonkey) {
                                return new CraftDonkey(server, (EntityDonkey) entity);
                ...
                // Monsters
                    ...
                    if (entity instanceof EntityZombie) {
                        if (entity instanceof EntityPigZombie) {
                            ...
                            return new CraftHusk(server, (EntityHusk) entity);
                        ...
                        if (entity instanceof EntityStray) {
                            return new CraftStray(server, (EntityStray) entity);
                        } else if (entity instanceof EntityWitherSkeleton) {
                            return new CraftWitherSkeleton(server, (EntityWitherSkeleton) entity);
                        } else {
                            return new CraftSkeleton(server, (AbstractSkeleton) entity);
                        }
                        ...
                        if (entity instanceof EntityElderGuardian) {
                            return new CraftElderGuardian(server, (EntityElderGuardian) entity);
                        } else {
                        ...
                        if (entity instanceof EntitySpellcasterIllager) {
                            if (entity instanceof EntityEvoker) {
                                ...
                                return new CraftIllusioner(server, (EntityIllusionIllager) entity);
                            } else {
                                return new CraftSpellcaster(server, (EntitySpellcasterIllager) entity);
                            }
            ...
            if (part.parent instanceof EntityDragon) {
                return new CraftEnderDragonPart(server, (MultiPartEntityPart) entity);
            } else {
                return new CraftComplexPart(server, (MultiPartEntityPart) entity);
            }
            ...
            if (entity instanceof EntityMinecartFurnace) {
                ...
                return new CraftMinecartRideable(server, (EntityMinecartEmpty) entity);
    ...
    public List<org.bukkit.entity.Entity> getPassengers() {
        return Lists.newArrayList(Lists.transform(getHandle().getPassengers(), (Function<Entity, org.bukkit.entity.Entity>) Entity::getBukkitEntity));
    }
