...
public class VersionCommand extends Command {
    ...
    public boolean execute(CommandSender sender, String currentAlias, String[] args) {
        ...
        if (args.length == 0) {
            sender.sendMessage("This server is running " + Bukkit.getName() + " version " + RealmExpertMC.getVersion() +  " (MC: 1.12.2) (Implementing API version " + Bukkit.getBukkitVersion() + ", Forge version " + ForgeVersion.getVersion() + ")");
        } else {
