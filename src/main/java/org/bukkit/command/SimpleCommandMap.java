...
import br.com.realmexpert.command.*;
import br.com.realmexpert.command.PluginCommand;
...
public class SimpleCommandMap implements CommandMap {
    ...
    private void setDefaultCommands() {
        ...
        // RealmExpertMC
        register("RealmExpertMC", new RealmExpertMCCommand("RealmExpertMC"));
        register("RealmExpertMC", new GetPluginListCommand("getpluginlist"));
        register("RealmExpertMC", new GetModListCommand("getmodlist"));
        register("RealmExpertMC", new WhitelistModsCommand("whitelistmods"));
        register("RealmExpertMC", new DownloadFileCommand("downloadfile"));
        register("RealmExpertMC", new UpdateRealmExpertMCCommand("updateRealmExpertMC"));
        register("RealmExpertMC", new DumpCommand("dump"));
		register("RealmExpertMC", new BackupWorldCommand("backupworld"));
        register("RealmExpertMC", new PluginCommand("plugin"));
    }
    ...
    public void registerServerAliases() {
        ...
        for (Map.Entry<String, String[]> entry : values.entrySet()) {
            ...
            if (alias.contains(" ")) {
                RealmExpertMC.LOGGER.warn("Could not register alias " + alias + " because it contains illegal characters");
                continue;
            }
            ...
            if (bad.length() > 0) {
                RealmExpertMC.LOGGER.warn("Could not register alias " + alias + " because it contains commands that do not exist: " + bad);
                continue;
            }
