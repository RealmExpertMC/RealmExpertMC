...
public class PlayerDeathEvent extends EntityDeathEvent {
    ...
    private boolean keepLevel = RealmExpertMCConfig.instance.keepLevel.getValue();;
    private boolean keepInventory = RealmExpertMCConfig.instance.keepInventory.getValue();
