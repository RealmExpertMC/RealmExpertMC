...
public class WatchdogThread extends Thread
{
    ...
    {
        super( "RealmExpertMC Watchdog Thread" );
    ...
    {
        if (RealmExpertMCConfig.instance.getBoolean("RealmExpertMC.watchdog_spigot")) {
    ...
    public void run()
    {
        while ( !stopping )
        {
            ...
            if ( lastTick != 0 && System.currentTimeMillis() > lastTick + timeoutTime )
            {
                ...
                log.log( Level.SEVERE, "RealmExpertMC version: " + Bukkit.getServer().getVersion() );
                ...
                //
                log.log( Level.SEVERE, "------------------------------" );
                log.log( Level.SEVERE, "Server thread dump (Look for plugins here before reporting to RealmExpertMC!):" );
