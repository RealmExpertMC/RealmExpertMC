...
public class SpigotConfig {
    ...
    private static void messages() {
        ...
        //unknownCommandMessage = transform( RealmExpertMCConfig.unknownCommandMessage );
        //outdatedClientMessage = transform(RealmExpertMCConfig.outdatedClientMessage);
        //outdatedServerMessage = transform( RealmExpertMCConfig.outdatedServerMessage );
    }
    ...
    private static void watchdog() {
        ...
        if (RealmExpertMCConfig.instance.watchdog_spigot.getValue()) {
    ...
    private static void nettyThreads() {
        ...
        Bukkit.getLogger().log(Level.INFO, Message.getString("RealmExpertMC.start.nettyio_count"), count);
    }
        ...
        for (String name : section.getKeys(true)) {
            if (section.isInt(name)) {
                if (StatList.getOneShotStat(name) == null) {
                    RealmExpertMC.LOGGER.warn("Ignoring non existent stats.forced-stats " + name);
                    continue;
                }
    ...
    private static void playerSample() {
        ...
        LogManager.getLogger("Spigot").info(Message.getString("RealmExpertMC.start.server_ping_count") + playerSample);
    }
