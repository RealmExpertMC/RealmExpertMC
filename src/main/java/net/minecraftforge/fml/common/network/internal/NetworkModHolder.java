    ...
    private class DefaultNetworkChecker extends NetworkChecker {
        ...
        public String checkCompatible(Map<String, String> remoteVersions, Side side)
        {
            ...
            if (acceptableRange != null)
            {
                ...
                {
                    versionString = String.format(RealmExpertMCConfig.instance.requirementsModVersion.getValue(), acceptableRange.toStringFriendly());
                }
                else
                {
                    versionString = String.format(RealmExpertMCConfig.instance.requirementsModVersionRange.getValue(), acceptableRange.toStringFriendly());
                }
            }
            else
            {
                versionString = String.format(RealmExpertMCConfig.instance.requirementsModVersion.getValue(), container.getVersion());
            }
            if (version != null)
            {
                return String.format(RealmExpertMCConfig.instance.requirementsModInvalidVersion.getValue(), versionString, version);
            }
            else
            {
                return String.format(RealmExpertMCConfig.instance.requirementsModNotFound.getValue(), versionString);
            }
        }
