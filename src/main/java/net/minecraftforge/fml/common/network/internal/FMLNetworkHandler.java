...
public class FMLNetworkHandler
{
    ...
    public static String checkModList(Map<String,String> listData, Side side)
    {
        ...
        if (rejects.isEmpty())
        {
            if(!hackpacks.isEmpty()) {
                FMLLog.info("[RealmExpertMC] Rejecting hacker %s: %s", side, hackpacks);
                return String.format(RealmExpertMCConfig.instance.rejectionsHackMessage.getValue(),hackpacks);
            }
            return null;
        }
        else
        {
            ...
            return String.format(RealmExpertMCConfig.instance.rejectionsServerModsMessage.getValue(), rejectString);
        }
    }
    ...
    public static void enhanceStatusQuery(JsonObject jsonobject)
    {
        ...
        fmlData.addProperty("type", RealmExpertMCConfig.instance.server_type.getValue());
