...
enum FMLHandshakeServerState implements IHandshakeState<FMLHandshakeServerState>
{
    ...
    HELLO
    {
        ...
        public void accept(ChannelHandlerContext ctx, FMLHandshakeMessage msg, Consumer<? super FMLHandshakeServerState> cons)
        {
            ...
            if (RealmExpertMCForgeUtils.modsblacklist(client.modListAsString())) {
                dispatcher.kickWithMessage(RealmExpertMCConfig.instance.modsblacklistkickMessage.getValue());
                return;
            }
            if (!RealmExpertMCForgeUtils.modswhittelist(client.modListAsString())) {
                dispatcher.kickWithMessage(RealmExpertMCConfig.instance.modswhitelistkickMessage.getValue());
                return;
            }
            ...
            if (!RealmExpertMCConfig.instance.hideJoinModsList.getValue()) {
