...
public class GameRegistry
{
    ...
    public static void registerWorldGenerator(IWorldGenerator generator, int modGenerationWeight)
    {
        ...
        if (!configWorldGenCache.containsKey(generator.getClass().getName()))
        {
            ...
            generatorEnabled = RealmExpertMCConfig.instance.getBoolean("world.disableforgegenerate.worldgen-" + generatorName, true);
            configWorldGenCache.put(generator.getClass().getName(), generatorEnabled);
        }
        if (RealmExpertMCConfig.instance.getString("world.disableforgegenerate.worldgen-" + generatorName)  == null) {
            RealmExpertMCConfig.instance.set("world.disableforgegenerate.worldgen-" + generatorName, generatorEnabled);
        }
    }
    ...
    {
        if (RealmExpertMCConfig.instance.disableforgegenerate_global.getValue().booleanValue()) {
            if (RealmExpertMCConfig.instance.getBoolean("world.disableforgegenerate.global.worlds." + world.getWorld().getName(), false)) {
                return;
            }
        }
        if (sortedGeneratorList == null)
