...
public class FakePlayerFactory
{
    ...
    public static FakePlayer get(WorldServer world, GameProfile username)
    {
        ...
        if (RealmExpertMCConfig.instance.fakePlayerLogin.getValue().booleanValue()) world.getServer().getPluginManager().callEvent(new PlayerJoinEvent(fakePlayer.getBukkitEntity(), world.getWorld()));
