...
import br.com.realmexpert.forge.ForgeInjectBukkit;
import br.com.realmexpert.forge.ModCompatibleFixUtils;
...
public class DimensionManager
{
    ...
    public static void registerDimension(int id, DimensionType type)
    {
        ...
        for (Integer dim : RealmExpertMCConfig.instance.dimensionsNotLoaded) {
            if (id != 0 && dim.intValue() == id) {
                return;
            }
        }
        ...
        // RealmExpertMC - register Environment to Bukkit
    ...
    public static void initDimension(int dim)
    {
        ...
        try
        {
            ...
            // RealmExpertMC start - Fixes MultiVerse issue when mods such as Twilight Forest try to hotload their dimension when using its WorldProvider
            if(RealmExpertMCForgeUtils.craftWorldLoading)
            {
                return;
            }
            // RealmExpertMC end
    ...
    public static void unloadWorld(int id)
    {
        ...
        if (!RealmExpertMCConfig.instance.autounloadworldenable.getValue()) return;
        for (String dim1 : RealmExpertMCConfig.instance.autounloadworld_whitelist) {
